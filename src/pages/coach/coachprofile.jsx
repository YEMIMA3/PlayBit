...
import { getCoachProfile, updateCoachProfile } from "../../api/coachProfile";
...
export default function CoachProfile() {
  ...
  const handleImageUpload = (event) => {
    ...
    if (file) {
      // For now, just show alert. You can implement upload later
          ...
          <div className="header-actions">
            {!isEditing ? (
              <button 
                ...
                disabled={loading}
              >
                {loading ? <Loader size={16} className="spinner" /> : 'Edit Profile'}
              </button>
            ) : (
              <div className="edit-actions">
                ...
                <button className="save-btn" onClick={handleSave} disabled={loading}>
                  {loading ? <Loader size={16} className="spinner" /> : 'Save Changes'}
                </button>
              </div>
            )}
          </div>
        ...
        <div className="profile-layout">
          ...
          <div className="profile-sidebar">
            ...
            <div className="quick-info">
              ...
              <div className="info-item">
                <Calendar size={16} />
                <span>{profile.experience || "Add experience"}</span>
              </div>
            </div>
          </div>
